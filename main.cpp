...
main(int ac, const char* av[])
{
    ...
    ([&](const crow::request& req) {
      return crow::response(gntlblocks.index2());
    });

    CROW_ROUTE(app, "/page/<uint>")
    ([&](size_t page_no) {
        return gntlblocks.index2(page_no);
    });

    CROW_ROUTE(app, "/block/<uint>")
    ([&](const crow::request& req, size_t block_height) {
        return crow::response(gntlblocks.show_block(block_height));
    });

    CROW_ROUTE(app, "/block/<string>")
    ([&](const crow::request& req, string block_hash) {
        return crow::response(gntlblocks.show_block(remove_bad_chars(block_hash)));
    });

    CROW_ROUTE(app, "/tx/<string>")
    ([&](string tx_hash) {
        return crow::response(gntlblocks.show_tx(remove_bad_chars(tx_hash)));
    });
    ...
    if (enable_as_hex)
    {
        ...
        ([&](string tx_hash) {
            return crow::response(gntlblocks.show_tx_hex(remove_bad_chars(tx_hash)));
        });

        CROW_ROUTE(app, "/ringmembershex/<string>")
        ([&](string tx_hash) {
            return crow::response(gntlblocks.show_ringmembers_hex(remove_bad_chars(tx_hash)));
        });

        CROW_ROUTE(app, "/blockhex/<uint>")
        ([&](size_t block_height) {
            return crow::response(gntlblocks.show_block_hex(block_height, false));
        });

        CROW_ROUTE(app, "/blockhexcomplete/<uint>")
        ([&](size_t block_height) {
            return crow::response(gntlblocks.show_block_hex(block_height, true));
        });
    ...
    ([&](string tx_hash, uint16_t with_ring_signatures)
     {
        return gntlblocks.show_tx(remove_bad_chars(tx_hash), with_ring_signatures);
    });
    ...
    ([&](const crow::request& req)
     {
        ...
        {
            return string("GNTL address, viewkey or tx hash not provided");
        }
    ...
    if (enable_pusher)
    {
        ...
        ([&](const crow::request& req) {
            ...
            if (action == "check")
                return gntlblocks.show_checkrawtx(raw_tx_data, action);
            else if (action == "push")
                return gntlblocks.show_pushrawtx(raw_tx_data, action);
    ...
    if (enable_key_image_checker)
    {
        ...
        ([&](const crow::request& req) {
            return gntlblocks.show_rawkeyimgs();
        });
        ...
        ([&](const crow::request& req) {
            ...
            return gntlblocks.show_checkrawkeyimgs(raw_data, viewkey);
        });
    }
    ...
    if (enable_output_key_checker)
    {
        ...
        ([&](const crow::request& req) {
            return gntlblocks.show_rawoutputkeys();
        });
        ...
        ([&](const crow::request& req) {
            ...
            return gntlblocks.show_checkcheckrawoutput(raw_data, viewkey);
        });
    }
    ...
    ([&](const crow::request& req) {
        return gntlblocks.search(remove_bad_chars(string(req.url_params.get("value"))));
    });

    CROW_ROUTE(app, "/mempool")
    ([&](const crow::request& req) {
        return gntlblocks.mempool(true);
    });
...
//    });
    ...
    CROW_ROUTE(app, "/blockchain.js")([&]() { return gntlblocks.get_blockchain_js(); });
    CROW_ROUTE(app, "/css/style.css")([&]() { return gntlblocks.get_css(); });
    ...
    if (enable_js)
    {
        ...
        ([&](const crow::request& req) {
            return gntlblocks.get_js_file("jquery.min.js");
        });

         CROW_ROUTE(app, "/js/crc32.js")
        ([&](const crow::request& req) {
            return gntlblocks.get_js_file("crc32.js");
        });

        CROW_ROUTE(app, "/js/biginteger.js")
        ([&](const crow::request& req) {
            return gntlblocks.get_js_file("biginteger.js");
        });

        CROW_ROUTE(app, "/js/crypto.js")
        ([&](const crow::request& req) {
            return gntlblocks.get_js_file("crypto.js");
        });

        CROW_ROUTE(app, "/js/config.js")
        ([&](const crow::request& req) {
            return gntlblocks.get_js_file("config.js");
        });

        CROW_ROUTE(app, "/js/nacl-fast-cn.js")
        ([&](const crow::request& req) {
            return gntlblocks.get_js_file("nacl-fast-cn.js");
        });

        CROW_ROUTE(app, "/js/base58.js")
        ([&](const crow::request& req) {
            return gntlblocks.get_js_file("base58.js");
        });

        CROW_ROUTE(app, "/js/cn_util.js")
        ([&](const crow::request& req) {
            return gntlblocks.get_js_file("cn_util.js");
        });

        CROW_ROUTE(app, "/js/sha3.js")
        ([&](const crow::request& req) {
            return gntlblocks.get_js_file("sha3.js");
        });
        ...
        ([&](const crow::request& req) {
            ...
            return gntlblocks.get_js_file("all_in_one.js");
        });
	...
	CROW_ROUTE(app, "/api")
        ([&](const crow::request& req) {
            return crow::response(gntlblocks.api());
        });
    ...
    if (enable_autorefresh_option)
    {
        ...
        ([&]() {
            ...
            return gntlblocks.index2(page_no, refresh_page);
        });
    }
