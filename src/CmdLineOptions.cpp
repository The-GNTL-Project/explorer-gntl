...
namespace gntleg
{
    ...
    CmdLineOptions::CmdLineOptions(int acc, const char *avv[]) {
        ...
        options_description desc(
                "gntlblocks, Onion GNTL Blockchain Explorer");
        ...
        desc.add_options()
                ...
                ("enable-emission-monitor", value<bool>()->default_value(false)->implicit_value(true),
                 "enable GNTL total emission monitoring thread")
                ...
                ("bc-path,b", value<string>(),
                 "path to lmdb folder of the blockchain, e.g., ~/.gntl/lmdb")
                ...
                ("daemon-url,d", value<string>()->default_value("http://127.0.0.1:16662"),
                 "GNTL daemon url");
